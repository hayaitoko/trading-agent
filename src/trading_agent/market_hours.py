...
Provides an ``is_market_open`` callable suitable for PaperBroker's
``is_market_open`` hook, so paper fills respect regular trading hours
(09:30–16:00 America/New_York, Mon–Fri). Holidays are not modelled — for
holiday-accurate behaviour, run against an Alpaca paper account instead.
"""
